Feature: My Account Test
  ...
  Scenario: User should register account successfully
    ...
    And I enter Last Name "Vekariya"
    And I enter Email "raj"
    And I enter Telephone "9510522522"
    And I enter Password "raj1234"
    And I enter Confirm Password "raj1234"
  ...
  Scenario: User should login and logout successfully
    ...
    And I enter password "raj1234" on login page
